    ...
    return(
        ...
        <div id = 'single-post-container'>
         ...
         <p>Location : {post.location}</p> 
          ...
          >Send Message To Seller</button> //the send message is exposedi if post is authored by someone else. Allows logged in user to send a message to seller or just view the post again
          : <><br></br></>
          }
        </div>
